...
public class vts_Live_Vehicle {
  ...
  String checksum;
  String sequenceno;
  String coarseoverground;
  String tracksatellite;
  String location;
  String deviceid;
  String mobileno;
  String customername;
...
public String getCoarseoverground() {
	return coarseoverground;
}
public void setCoarseoverground(String coarseoverground) {
	this.coarseoverground = coarseoverground;
}
public String getTracksatellite() {
	return tracksatellite;
}
public void setTracksatellite(String tracksatellite) {
...
public String getTemperstatus() {
	return temperstatus;
}
public void setTemperstatus(String temperstatus) {
...
public void setIgnumber(String ignumber) {

...
public class vehicle_details {
	...
	public Long getFullpump() {
		return fullpump;
	}
	public void setFullpump(Long fullpump) {
		this.fullpump = fullpump;
	}
	...
	public Long getCodometer() {
		return codometer;
	}
	public void setCodometer(Long codometer) {
	...
	public void setNodometer(Long nodometer) {
		this.nodometer = nodometer;
	}
	public Long getLodometer() {
		return lodometer;
	}
	public void setLodometer(Long lodometer) {
		this.lodometer = lodometer;
	}
